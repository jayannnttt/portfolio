...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: 'GhostTraffic',
    status: 'in-progress',
    tagline: 'Computer vision traffic & accident analysis tool',
    description: [
      'GhostTraffic is a computer vision application engineered to analyze traffic footage and isolate accident incidents.',
      'Features vehicle classification, trajectory reconstruction, instantaneous speed tracking, and automated collision isolation.',
    ],
